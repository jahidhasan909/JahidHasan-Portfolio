  ...
  return (
    <footer className="pt-20 relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col items-center relative z-10">
        ...
        <motion.div>
          <p className="text-[12px] mb-7 text-center text-text-secondary font-bold flex items-center gap-2  tracking-[0.1em]">
      ...
      <div className="w-24  mx-auto h-1 bg-gradient-to-r from-accent-blue to-accent-purple mt-10 mb-3 rounded-full" />
      {/* Copyright */}
